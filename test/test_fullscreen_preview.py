...
def test_fullscreen_preview():
    ...
    print("\n全屏预览功能:")
    print("1. 模态框：使用modal-fullscreen全屏显示")
    print("2. 视频：高度为calc(100vh - 200px)，居中显示")
    print("3. 图片：高度为calc(100vh - 200px)，支持缩放")
    print("4. 布局：视频和图片都使用flex布局居中")
    print("5. 缩放：图片支持点击放大/缩小")
    
    print("\n使用方法:")
    print("1. 点击文件卡片预览")
    print("2. 视频：全屏显示，支持播放控制")
    print("3. 图片：全屏显示，点击可放大/缩小")
    print("4. 按ESC或点击关闭按钮退出全屏")

if __name__ == '__main__':
    test_fullscreen_preview() 